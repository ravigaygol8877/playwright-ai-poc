...
import { KnowledgeBaseGenerator } from "../../knowledge-base/KnowledgeBaseGenerator.js";
import { ExcelReader }            from "../../src/requirements/ExcelReader.js";
...
async function main() {
  ...
  for (const [pageKey, url] of parseResult.pageUrls) {
    ...
    if (fs.existsSync(cacheFile)) {
      const cached = JSON.parse(fs.readFileSync(cacheFile, "utf-8")) as import("./discovery/ScenarioInferenceEngine.js").InferredScenario[];
