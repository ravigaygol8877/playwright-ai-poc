...
import { POMGenerator, kbKeyToClassName } from "./POMGenerator.js";
import { DataFileGenerator }   from "./DataFileGenerator.js";
import { FixtureUpdater, classNameToFixtureKey } from "./FixtureUpdater.js";

const PAGES_DIR    = "src/pages";
const DATA_DIR     = "src/data";
const FIXTURES_FILE = "src/fixtures/index.ts";
